...
def train(checkpoint_dir, batch_size, learning_rate):
   ...
   images = tf.placeholder(tf.float32, shape=(batch_size, 64, 64, 1), name='real_images')

   # placeholder for the images generated by G
   sample_images = tf.placeholder(tf.float32, shape=(batch_size, 64, 64, 1), name='sample_images')
   ...
   while True:
      ...
      batch_images = imnet.get_batch(batch_size, 'train')
