...
\begin{figure}[!htb]
   \begin{center}$
      \begin{array}{cccc}
         \includegraphics[width=2in]{dcgan_results} \hspace{10mm}
         \includegraphics[width=2in]{lsgan_results}
      \end{array}$
   \end{center}
...
\begin{figure}[!htb]
   \begin{center}$
      \begin{array}{cccc}
         \includegraphics[width=2in]{ebgan_results} \hspace{10mm}
         \includegraphics[width=2in]{wgan_results}
      \end{array}$
   \end{center}
...
\begin{figure}[!htb]
   \begin{center}$
      \begin{array}{cccc}
         \includegraphics[width=3in]{legacy}
      \end{array}$
   \end{center}
   \caption{Top: Results using various GAN models. Bottom: Results using the \cite{zhao2016energy} model.}
\end{figure}
