...
Results can be seen in Figure 6, and visually match those presented in the paper.
...
\begin{figure}[!htb]
   \begin{center}$
      ...
      \end{array}$
   \end{center}
   \caption{Top Row: Generator and Discriminator losses, respectively for DCGANs for the results shown in Figure 2. Bottom Row: Generator and Discriminator loss for WGAN for the. 
   results shown in Figure 7. While visual quality is increasing in both models, the WGAN loss clearly shows convergence that correlates with visual quality, while the loss for DCGANs stays constant.}
\end{figure}
