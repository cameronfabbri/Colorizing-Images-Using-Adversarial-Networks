...
images in a more explicit manner. To compare with the results I obtained from [1], I implemented and trained a DCGAN on MNIST. Results can be seen compared to my implementation of GANs using a MLP in Figure 3,
...
%All GAN variations besides WGAN took a little over 2 days to train on the 200,000 images from CelebA on a GTX 1080 (8 epochs).
...
\begin{figure}[!htb]
   \begin{center}$
      ...
      \end{array}$
   \end{center}
   \caption{\textit{Variations from different models. From left to right: Input Image, GAN $L_1=100$ $L_2=0$, GAN $L_1=0$ $L_2=1$,  LSGAN $L_1=100$ $L_2=0$, LSGAN $L_1=0$ $L_2=1$,  EBGAN $L_1=100$ $L_2=0$,
...
compare, I also tested on a true grayscale image of John F. Kennedy, seen in Figure 10. Note this image not only wasn't trained on, but is completely outside of our dataset.
...
\begin{figure}[!htb]
   \begin{center}$
      ...
      \end{array}$
   \end{center}
   \caption{\textit{Colorizing a true black and white photo. From left to right: Input Image, GAN $L_1=100$ $L_2=0$, GAN $L_1=0$ $L_2=1$,  LSGAN $L_1=100$ $L_2=0$, LSGAN $L_1=0$ $L_2=1$,  EBGAN $L_1=100$ $L_2=0$,
      EBGAN $L_1=0$ $L_2=1$, WGAN $L_1=100$ $L_2=0$, WGAN $L_1=0$ $L_2=1$. Note no true color image is available for this photo.}}
\end{figure}
