...
in [5], this distance metric suffers from the vanishing gradient problem, 
...
%-------------------------------------------------%
I now show how adversarial networks can be used for generating a plausible color version of a grayscale image.
