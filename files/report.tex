...
\begin{figure}[!htb]
   \begin{center}$
      ...
      \end{array}$
   \end{center}
   \caption{\textit{Variations from different models. L1 and L2 here refer to the $\lambda$ values in the objective function. From left to right: Input Image, GAN $L_1=100$ $L_2=0$, GAN $L_1=0$ $L_2=1$, 
